...
proc registerVirtual_getPartialData*[T: StreamPeerExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_partial_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_putData*[T: StreamPeerExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_put_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_putPartialData*[T: StreamPeerExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_put_partial_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAvailableBytes*[T: StreamPeerExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_available_bytes"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
