...
proc registerVirtual_getRenderSceneBuffers*[T: RenderDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_render_scene_buffers"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getRenderSceneData*[T: RenderDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_render_scene_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getEnvironment*[T: RenderDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_environment"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getCameraAttributes*[T: RenderDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_camera_attributes"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
