...
proc registerVirtual_getCapabilities*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_capabilities"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isInitialized*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_initialized"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_uninitialize*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_uninitialize"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getSystemInfo*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_system_info"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_supportsPlayAreaMode*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_supports_play_area_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPlayAreaMode*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_play_area_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setPlayAreaMode*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_play_area_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPlayArea*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_play_area"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getRenderTargetSize*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_render_target_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getViewCount*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_view_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getCameraTransform*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_camera_transform"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getTransformForView*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_transform_for_view"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getProjectionForView*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_projection_for_view"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getVrsTexture*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_vrs_texture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_preRender*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_pre_render"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_preDrawViewport*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_pre_draw_viewport"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_postDrawViewport*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_post_draw_viewport"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_endFrame*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_end_frame"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getSuggestedPoseNames*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_suggested_pose_names"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getTrackingStatus*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_tracking_status"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_triggerHapticPulse*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_trigger_haptic_pulse"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAnchorDetectionIsEnabled*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_anchor_detection_is_enabled"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setAnchorDetectionIsEnabled*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_anchor_detection_is_enabled"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getCameraFeedId*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_camera_feed_id"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getColorTexture*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_color_texture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getDepthTexture*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_depth_texture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getVelocityTexture*[T: XRInterfaceExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_velocity_texture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
