...
proc registerVirtual_setWriteMode*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_set_write_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getWriteMode*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_write_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_wasStringPacket*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_was_string_packet"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getReadyState*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_ready_state"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getLabel*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_label"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isOrdered*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_is_ordered"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getId*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_id"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getMaxPacketLifeTime*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_max_packet_life_time"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getMaxRetransmits*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_max_retransmits"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getProtocol*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_protocol"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isNegotiated*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_is_negotiated"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getBufferedAmount*[T: WebRTCDataChannelExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_buffered_amount"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
