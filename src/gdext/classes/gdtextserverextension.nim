...
proc registerVirtual_hasFeature*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_has_feature"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getFeatures*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_features"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_freeRid*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_free_rid"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_has*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_has"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_loadSupportData*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_load_support_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getSupportDataFilename*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_support_data_filename"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getSupportDataInfo*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_support_data_info"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_saveSupportData*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_save_support_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getSupportData*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_support_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isLocaleRightToLeft*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_locale_right_to_left"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_nameToTag*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_name_to_tag"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_tagToName*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_tag_to_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_createFont*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_create_font"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_createFontLinkedVariation*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_create_font_linked_variation"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetData*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetDataPtr*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_data_ptr"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetFaceIndex*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_face_index"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetFaceIndex*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_face_index"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetFaceCount*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_face_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetStyle*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_style"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetStyle*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_style"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetName*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetName*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetOtNameStrings*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_ot_name_strings"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetStyleName*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_style_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetStyleName*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_style_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetWeight*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_weight"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetWeight*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_weight"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetStretch*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_stretch"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetStretch*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_stretch"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetAntialiasing*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_antialiasing"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetAntialiasing*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_antialiasing"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetDisableEmbeddedBitmaps*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_disable_embedded_bitmaps"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetDisableEmbeddedBitmaps*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_disable_embedded_bitmaps"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetGenerateMipmaps*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_generate_mipmaps"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGenerateMipmaps*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_generate_mipmaps"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetMultichannelSignedDistanceField*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_multichannel_signed_distance_field"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontIsMultichannelSignedDistanceField*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_is_multichannel_signed_distance_field"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetMsdfPixelRange*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_msdf_pixel_range"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetMsdfPixelRange*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_msdf_pixel_range"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetMsdfSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_msdf_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetMsdfSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_msdf_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetFixedSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_fixed_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetFixedSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_fixed_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetFixedSizeScaleMode*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_fixed_size_scale_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetFixedSizeScaleMode*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_fixed_size_scale_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetAllowSystemFallback*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_allow_system_fallback"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontIsAllowSystemFallback*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_is_allow_system_fallback"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetForceAutohinter*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_force_autohinter"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontIsForceAutohinter*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_is_force_autohinter"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetHinting*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_hinting"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetHinting*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_hinting"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetSubpixelPositioning*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_subpixel_positioning"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetSubpixelPositioning*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_subpixel_positioning"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetKeepRoundingRemainders*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_keep_rounding_remainders"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetKeepRoundingRemainders*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_keep_rounding_remainders"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetEmbolden*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_embolden"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetEmbolden*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_embolden"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetSpacing*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_spacing"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetSpacing*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_spacing"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetBaselineOffset*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_baseline_offset"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetBaselineOffset*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_baseline_offset"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetTransform*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_transform"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetTransform*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_transform"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetVariationCoordinates*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_variation_coordinates"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetVariationCoordinates*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_variation_coordinates"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetOversampling*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_oversampling"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetOversampling*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_oversampling"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetSizeCacheList*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_size_cache_list"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontClearSizeCache*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_clear_size_cache"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontRemoveSizeCache*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_remove_size_cache"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetAscent*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_ascent"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetAscent*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_ascent"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetDescent*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_descent"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetDescent*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_descent"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetUnderlinePosition*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_underline_position"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetUnderlinePosition*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_underline_position"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetUnderlineThickness*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_underline_thickness"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetUnderlineThickness*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_underline_thickness"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetScale*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_scale"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetScale*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_scale"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetTextureCount*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_texture_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontClearTextures*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_clear_textures"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontRemoveTexture*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_remove_texture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetTextureImage*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_texture_image"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetTextureImage*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_texture_image"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetTextureOffsets*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_texture_offsets"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetTextureOffsets*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_texture_offsets"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphList*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_list"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontClearGlyphs*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_clear_glyphs"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontRemoveGlyph*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_remove_glyph"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphAdvance*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_advance"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetGlyphAdvance*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_glyph_advance"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphOffset*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_offset"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetGlyphOffset*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_glyph_offset"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetGlyphSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_glyph_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphUvRect*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_uv_rect"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetGlyphUvRect*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_glyph_uv_rect"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphTextureIdx*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_texture_idx"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetGlyphTextureIdx*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_glyph_texture_idx"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphTextureRid*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_texture_rid"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphTextureSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_texture_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphContours*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_contours"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetKerningList*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_kerning_list"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontClearKerningMap*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_clear_kerning_map"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontRemoveKerning*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_remove_kerning"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetKerning*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_kerning"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetKerning*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_kerning"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlyphIndex*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_glyph_index"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetCharFromGlyphIndex*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_char_from_glyph_index"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontHasChar*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_has_char"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetSupportedChars*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_supported_chars"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetSupportedGlyphs*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_supported_glyphs"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontRenderRange*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_render_range"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontRenderGlyph*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_render_glyph"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontDrawGlyph*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_draw_glyph"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontDrawGlyphOutline*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_draw_glyph_outline"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontIsLanguageSupported*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_is_language_supported"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetLanguageSupportOverride*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_language_support_override"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetLanguageSupportOverride*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_language_support_override"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontRemoveLanguageSupportOverride*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_remove_language_support_override"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetLanguageSupportOverrides*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_language_support_overrides"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontIsScriptSupported*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_is_script_supported"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetScriptSupportOverride*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_script_support_override"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetScriptSupportOverride*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_script_support_override"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontRemoveScriptSupportOverride*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_remove_script_support_override"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetScriptSupportOverrides*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_script_support_overrides"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetOpentypeFeatureOverrides*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_opentype_feature_overrides"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetOpentypeFeatureOverrides*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_opentype_feature_overrides"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSupportedFeatureList*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_supported_feature_list"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSupportedVariationList*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_supported_variation_list"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontGetGlobalOversampling*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_get_global_oversampling"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_fontSetGlobalOversampling*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_font_set_global_oversampling"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getHexCodeBoxSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_hex_code_box_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_drawHexCodeBox*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_draw_hex_code_box"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_createShapedText*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_create_shaped_text"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextClear*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_clear"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSetDirection*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_set_direction"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetDirection*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_direction"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetInferredDirection*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_inferred_direction"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSetBidiOverride*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_set_bidi_override"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSetCustomPunctuation*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_set_custom_punctuation"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetCustomPunctuation*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_custom_punctuation"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSetCustomEllipsis*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_set_custom_ellipsis"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetCustomEllipsis*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_custom_ellipsis"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSetOrientation*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_set_orientation"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetOrientation*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_orientation"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSetPreserveInvalid*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_set_preserve_invalid"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetPreserveInvalid*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_preserve_invalid"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSetPreserveControl*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_set_preserve_control"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetPreserveControl*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_preserve_control"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSetSpacing*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_set_spacing"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetSpacing*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_spacing"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextAddString*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_add_string"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextAddObject*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_add_object"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextResizeObject*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_resize_object"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedGetSpanCount*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_get_span_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedGetSpanMeta*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_get_span_meta"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedGetSpanEmbeddedObject*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_get_span_embedded_object"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedSetSpanUpdateFont*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_set_span_update_font"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSubstr*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_substr"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetParent*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_parent"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextFitToWidth*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_fit_to_width"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextTabAlign*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_tab_align"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextShape*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_shape"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextUpdateBreaks*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_update_breaks"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextUpdateJustificationOps*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_update_justification_ops"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextIsReady*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_is_ready"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetGlyphs*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_glyphs"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextSortLogical*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_sort_logical"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetGlyphCount*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_glyph_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetRange*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_range"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetLineBreaksAdv*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_line_breaks_adv"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetLineBreaks*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_line_breaks"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetWordBreaks*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_word_breaks"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetTrimPos*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_trim_pos"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetEllipsisPos*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_ellipsis_pos"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetEllipsisGlyphCount*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_ellipsis_glyph_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetEllipsisGlyphs*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_ellipsis_glyphs"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextOverrunTrimToWidth*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_overrun_trim_to_width"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetObjects*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_objects"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetObjectRect*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_object_rect"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetObjectRange*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_object_range"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetObjectGlyph*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_object_glyph"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetSize*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_size"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetAscent*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_ascent"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetDescent*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_descent"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetWidth*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_width"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetUnderlinePosition*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_underline_position"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetUnderlineThickness*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_underline_thickness"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetDominantDirectionInRange*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_dominant_direction_in_range"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetCarets*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_carets"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetSelection*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_selection"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextHitTestGrapheme*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_hit_test_grapheme"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextHitTestPosition*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_hit_test_position"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextDraw*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_draw"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextDrawOutline*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_draw_outline"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetGraphemeBounds*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_grapheme_bounds"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextNextGraphemePos*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_next_grapheme_pos"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextPrevGraphemePos*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_prev_grapheme_pos"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextGetCharacterBreaks*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_get_character_breaks"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextNextCharacterPos*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_next_character_pos"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextPrevCharacterPos*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_prev_character_pos"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapedTextClosestCharacterPos*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shaped_text_closest_character_pos"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_formatNumber*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_format_number"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_parseNumber*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_parse_number"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_percentSign*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_percent_sign"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_stripDiacritics*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_strip_diacritics"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isValidIdentifier*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_valid_identifier"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isValidLetter*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_valid_letter"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_stringGetWordBreaks*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_string_get_word_breaks"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_stringGetCharacterBreaks*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_string_get_character_breaks"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isConfusable*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_confusable"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_spoofCheck*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_spoof_check"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_stringToUpper*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_string_to_upper"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_stringToLower*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_string_to_lower"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_stringToTitle*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_string_to_title"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_parseStructuredText*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_parse_structured_text"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_cleanup*[T: TextServerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_cleanup"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
