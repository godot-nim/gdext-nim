...
proc registerVirtual_placeholderErased*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_placeholder_erased"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_canInstantiate*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_can_instantiate"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getBaseScript*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_base_script"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getGlobalName*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_global_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_inheritsScript*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_inherits_script"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getInstanceBaseType*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_instance_base_type"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_instanceCreate*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_instance_create"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_placeholderInstanceCreate*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_placeholder_instance_create"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_instanceHas*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_instance_has"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_hasSourceCode*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_has_source_code"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getSourceCode*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_source_code"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setSourceCode*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_set_source_code"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_reload*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_reload"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getClassIconPath*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_class_icon_path"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_hasMethod*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_has_method"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_hasStaticMethod*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_has_static_method"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isTool*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_is_tool"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isValid*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_is_valid"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isAbstract*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_is_abstract"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getLanguage*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_language"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_hasPropertyDefaultValue*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_has_property_default_value"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPropertyDefaultValue*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_property_default_value"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isPlaceholderFallbackEnabled*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_is_placeholder_fallback_enabled"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getRpcConfig*[T: ScriptExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_rpc_config"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
