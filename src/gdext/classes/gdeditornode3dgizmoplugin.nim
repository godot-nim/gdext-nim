...
proc registerVirtual_hasGizmo*[T: EditorNode3DGizmoPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_has_gizmo"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_createGizmo*[T: EditorNode3DGizmoPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_create_gizmo"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getGizmoName*[T: EditorNode3DGizmoPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_gizmo_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_canBeHidden*[T: EditorNode3DGizmoPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_can_be_hidden"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isSelectableWhenHidden*[T: EditorNode3DGizmoPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_selectable_when_hidden"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
