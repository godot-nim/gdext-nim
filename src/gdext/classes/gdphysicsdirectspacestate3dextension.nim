...
proc registerVirtual_intersectRay*[T: PhysicsDirectSpaceState3DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_intersect_ray"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_intersectPoint*[T: PhysicsDirectSpaceState3DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_intersect_point"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_intersectShape*[T: PhysicsDirectSpaceState3DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_intersect_shape"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_castMotion*[T: PhysicsDirectSpaceState3DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_cast_motion"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_collideShape*[T: PhysicsDirectSpaceState3DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_collide_shape"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_restInfo*[T: PhysicsDirectSpaceState3DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_rest_info"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getClosestPointToObjectVolume*[T: PhysicsDirectSpaceState3DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_closest_point_to_object_volume"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
