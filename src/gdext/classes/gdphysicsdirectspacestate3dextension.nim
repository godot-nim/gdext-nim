...
proc registerVirtual_getClosestPointToObjectVolume*[T: PhysicsDirectSpaceState3DExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_closest_point_to_object_volume"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
