...
proc registerVirtual_generate*[T: EditorResourcePreviewGenerator](Self: typedesc[T]) =
  Self.vmethods[stringName"_generate"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_generateFromPath*[T: EditorResourcePreviewGenerator](Self: typedesc[T]) =
  Self.vmethods[stringName"_generate_from_path"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_generateSmallPreviewAutomatically*[T: EditorResourcePreviewGenerator](Self: typedesc[T]) =
  Self.vmethods[stringName"_generate_small_preview_automatically"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_canGenerateSmallPreview*[T: EditorResourcePreviewGenerator](Self: typedesc[T]) =
  Self.vmethods[stringName"_can_generate_small_preview"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
