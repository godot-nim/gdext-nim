...
proc registerVirtual_getPacketScript*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_packet_script"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_putPacketScript*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_put_packet_script"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPacketChannel*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_packet_channel"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPacketMode*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_packet_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setTransferChannel*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_transfer_channel"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getTransferChannel*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_transfer_channel"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setTransferMode*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_transfer_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getTransferMode*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_transfer_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setTargetPeer*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_target_peer"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPacketPeer*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_packet_peer"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isServer*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_server"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_disconnectPeer*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_disconnect_peer"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getUniqueId*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_unique_id"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setRefuseNewConnections*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_refuse_new_connections"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isRefusingNewConnections*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_refusing_new_connections"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isServerRelaySupported*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_server_relay_supported"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getConnectionStatus*[T: MultiplayerPeerExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_connection_status"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
