...
proc registerVirtual_setMultiplayerPeer*[T: MultiplayerAPIExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_multiplayer_peer"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getMultiplayerPeer*[T: MultiplayerAPIExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_multiplayer_peer"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPeerIds*[T: MultiplayerAPIExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_peer_ids"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_rpc*[T: MultiplayerAPIExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_rpc"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getRemoteSenderId*[T: MultiplayerAPIExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_remote_sender_id"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_objectConfigurationAdd*[T: MultiplayerAPIExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_object_configuration_add"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_objectConfigurationRemove*[T: MultiplayerAPIExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_object_configuration_remove"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
