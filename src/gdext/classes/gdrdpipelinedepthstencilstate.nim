...
proc setEnableDepthTest*(self: RDPipelineDepthStencilState; pMember: bool): void =
  ...
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_enable_depth_test", 2586408642)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getEnableDepthTest*(self: RDPipelineDepthStencilState): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_enable_depth_test", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setEnableDepthWrite*(self: RDPipelineDepthStencilState; pMember: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_enable_depth_write", 2586408642)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getEnableDepthWrite*(self: RDPipelineDepthStencilState): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_enable_depth_write", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setDepthCompareOperator*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_CompareOperator): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_depth_compare_operator", 2573711505)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getDepthCompareOperator*(self: RDPipelineDepthStencilState): RenderingDevice_CompareOperator =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_depth_compare_operator", 269730778)
...
proc setEnableDepthRange*(self: RDPipelineDepthStencilState; pMember: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_enable_depth_range", 2586408642)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getEnableDepthRange*(self: RDPipelineDepthStencilState): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_enable_depth_range", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setDepthRangeMin*(self: RDPipelineDepthStencilState; pMember: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_depth_range_min", 373806689)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getDepthRangeMin*(self: RDPipelineDepthStencilState): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_depth_range_min", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setDepthRangeMax*(self: RDPipelineDepthStencilState; pMember: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_depth_range_max", 373806689)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getDepthRangeMax*(self: RDPipelineDepthStencilState): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_depth_range_max", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setEnableStencil*(self: RDPipelineDepthStencilState; pMember: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_enable_stencil", 2586408642)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getEnableStencil*(self: RDPipelineDepthStencilState): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_enable_stencil", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setFrontOpFail*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_StencilOperation): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_front_op_fail", 2092799566)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getFrontOpFail*(self: RDPipelineDepthStencilState): RenderingDevice_StencilOperation =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_front_op_fail", 1714732389)
  methodbind.ptrcall(self, [], RenderingDevice_StencilOperation)

proc setFrontOpPass*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_StencilOperation): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_front_op_pass", 2092799566)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getFrontOpPass*(self: RDPipelineDepthStencilState): RenderingDevice_StencilOperation =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_front_op_pass", 1714732389)
  methodbind.ptrcall(self, [], RenderingDevice_StencilOperation)

proc setFrontOpDepthFail*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_StencilOperation): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_front_op_depth_fail", 2092799566)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getFrontOpDepthFail*(self: RDPipelineDepthStencilState): RenderingDevice_StencilOperation =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_front_op_depth_fail", 1714732389)
  methodbind.ptrcall(self, [], RenderingDevice_StencilOperation)

proc setFrontOpCompare*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_CompareOperator): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_front_op_compare", 2573711505)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getFrontOpCompare*(self: RDPipelineDepthStencilState): RenderingDevice_CompareOperator =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_front_op_compare", 269730778)
  methodbind.ptrcall(self, [], RenderingDevice_CompareOperator)

proc setFrontOpCompareMask*(self: RDPipelineDepthStencilState; pMember: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_front_op_compare_mask", 1286410249)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getFrontOpCompareMask*(self: RDPipelineDepthStencilState): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_front_op_compare_mask", 3905245786)
  methodbind.ptrcall(self, [], uint32)

proc setFrontOpWriteMask*(self: RDPipelineDepthStencilState; pMember: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_front_op_write_mask", 1286410249)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getFrontOpWriteMask*(self: RDPipelineDepthStencilState): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_front_op_write_mask", 3905245786)
  methodbind.ptrcall(self, [], uint32)

proc setFrontOpReference*(self: RDPipelineDepthStencilState; pMember: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_front_op_reference", 1286410249)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getFrontOpReference*(self: RDPipelineDepthStencilState): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_front_op_reference", 3905245786)
  methodbind.ptrcall(self, [], uint32)

proc setBackOpFail*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_StencilOperation): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_back_op_fail", 2092799566)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getBackOpFail*(self: RDPipelineDepthStencilState): RenderingDevice_StencilOperation =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_back_op_fail", 1714732389)
  methodbind.ptrcall(self, [], RenderingDevice_StencilOperation)

proc setBackOpPass*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_StencilOperation): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_back_op_pass", 2092799566)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getBackOpPass*(self: RDPipelineDepthStencilState): RenderingDevice_StencilOperation =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_back_op_pass", 1714732389)
  methodbind.ptrcall(self, [], RenderingDevice_StencilOperation)

proc setBackOpDepthFail*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_StencilOperation): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_back_op_depth_fail", 2092799566)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getBackOpDepthFail*(self: RDPipelineDepthStencilState): RenderingDevice_StencilOperation =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_back_op_depth_fail", 1714732389)
  methodbind.ptrcall(self, [], RenderingDevice_StencilOperation)

proc setBackOpCompare*(self: RDPipelineDepthStencilState; pMember: RenderingDevice_CompareOperator): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_back_op_compare", 2573711505)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getBackOpCompare*(self: RDPipelineDepthStencilState): RenderingDevice_CompareOperator =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_back_op_compare", 269730778)
  methodbind.ptrcall(self, [], RenderingDevice_CompareOperator)

proc setBackOpCompareMask*(self: RDPipelineDepthStencilState; pMember: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_back_op_compare_mask", 1286410249)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getBackOpCompareMask*(self: RDPipelineDepthStencilState): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_back_op_compare_mask", 3905245786)
  methodbind.ptrcall(self, [], uint32)

proc setBackOpWriteMask*(self: RDPipelineDepthStencilState; pMember: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_back_op_write_mask", 1286410249)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getBackOpWriteMask*(self: RDPipelineDepthStencilState): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_back_op_write_mask", 3905245786)
  methodbind.ptrcall(self, [], uint32)

proc setBackOpReference*(self: RDPipelineDepthStencilState; pMember: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "set_back_op_reference", 1286410249)
  methodbind.ptrcall(self, [getPtr pMember], void)

proc getBackOpReference*(self: RDPipelineDepthStencilState): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RDPipelineDepthStencilState, "get_back_op_reference", 3905245786)
  methodbind.ptrcall(self, [], uint32)
