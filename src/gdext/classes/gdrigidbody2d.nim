...
proc setMass*(self: RigidBody2D; mass: Float): void =
  ...
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_mass", 373806689)
  methodbind.ptrcall(self, [getPtr mass], void)

proc getMass*(self: RigidBody2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_mass", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc getInertia*(self: RigidBody2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_inertia", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setInertia*(self: RigidBody2D; inertia: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_inertia", 373806689)
...
proc setCenterOfMassMode*(self: RigidBody2D; mode: RigidBody2D_CenterOfMassMode): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_center_of_mass_mode", 1757235706)
  methodbind.ptrcall(self, [getPtr mode], void)

proc getCenterOfMassMode*(self: RigidBody2D): RigidBody2D_CenterOfMassMode =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_center_of_mass_mode", 3277132817)
  methodbind.ptrcall(self, [], RigidBody2D_CenterOfMassMode)

proc setCenterOfMass*(self: RigidBody2D; centerOfMass: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_center_of_mass", 743155724)
  methodbind.ptrcall(self, [getPtr centerOfMass], void)

proc getCenterOfMass*(self: RigidBody2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_center_of_mass", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc setPhysicsMaterialOverride*(self: RigidBody2D; physicsMaterialOverride: gdref PhysicsMaterial): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_physics_material_override", 1784508650)
...
proc getPhysicsMaterialOverride*(self: RigidBody2D): gdref PhysicsMaterial =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_physics_material_override", 2521850424)
  methodbind.ptrcall(self, [], gdref PhysicsMaterial)

proc setGravityScale*(self: RigidBody2D; gravityScale: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_gravity_scale", 373806689)
  methodbind.ptrcall(self, [getPtr gravityScale], void)

proc getGravityScale*(self: RigidBody2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_gravity_scale", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setLinearDampMode*(self: RigidBody2D; linearDampMode: RigidBody2D_DampMode): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_linear_damp_mode", 3406533708)
  methodbind.ptrcall(self, [getPtr linearDampMode], void)

proc getLinearDampMode*(self: RigidBody2D): RigidBody2D_DampMode =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_linear_damp_mode", 2970511462)
  methodbind.ptrcall(self, [], RigidBody2D_DampMode)

proc setAngularDampMode*(self: RigidBody2D; angularDampMode: RigidBody2D_DampMode): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_angular_damp_mode", 3406533708)
  methodbind.ptrcall(self, [getPtr angularDampMode], void)

proc getAngularDampMode*(self: RigidBody2D): RigidBody2D_DampMode =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_angular_damp_mode", 2970511462)
  methodbind.ptrcall(self, [], RigidBody2D_DampMode)

proc setLinearDamp*(self: RigidBody2D; linearDamp: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_linear_damp", 373806689)
  methodbind.ptrcall(self, [getPtr linearDamp], void)

proc getLinearDamp*(self: RigidBody2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_linear_damp", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setAngularDamp*(self: RigidBody2D; angularDamp: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_angular_damp", 373806689)
  methodbind.ptrcall(self, [getPtr angularDamp], void)

proc getAngularDamp*(self: RigidBody2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_angular_damp", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setLinearVelocity*(self: RigidBody2D; linearVelocity: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_linear_velocity", 743155724)
  methodbind.ptrcall(self, [getPtr linearVelocity], void)

proc getLinearVelocity*(self: RigidBody2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_linear_velocity", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc setAngularVelocity*(self: RigidBody2D; angularVelocity: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_angular_velocity", 373806689)
  methodbind.ptrcall(self, [getPtr angularVelocity], void)

proc getAngularVelocity*(self: RigidBody2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_angular_velocity", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setMaxContactsReported*(self: RigidBody2D; amount: int32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_max_contacts_reported", 1286410249)
  methodbind.ptrcall(self, [getPtr amount], void)

proc getMaxContactsReported*(self: RigidBody2D): int32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_max_contacts_reported", 3905245786)
  methodbind.ptrcall(self, [], int32)

proc getContactCount*(self: RigidBody2D): int32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_contact_count", 3905245786)
  methodbind.ptrcall(self, [], int32)

proc setUseCustomIntegrator*(self: RigidBody2D; enable: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_use_custom_integrator", 2586408642)
  methodbind.ptrcall(self, [getPtr enable], void)

proc isUsingCustomIntegrator*(self: RigidBody2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "is_using_custom_integrator", 2240911060)
  methodbind.ptrcall(self, [], bool)

proc setContactMonitor*(self: RigidBody2D; enabled: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_contact_monitor", 2586408642)
  methodbind.ptrcall(self, [getPtr enabled], void)

proc isContactMonitorEnabled*(self: RigidBody2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "is_contact_monitor_enabled", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setContinuousCollisionDetectionMode*(self: RigidBody2D; mode: RigidBody2D_CCDMode): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_continuous_collision_detection_mode", 1000241384)
  methodbind.ptrcall(self, [getPtr mode], void)

proc getContinuousCollisionDetectionMode*(self: RigidBody2D): RigidBody2D_CCDMode =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_continuous_collision_detection_mode", 815214376)
  methodbind.ptrcall(self, [], RigidBody2D_CCDMode)

proc setAxisVelocity*(self: RigidBody2D; axisVelocity: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_axis_velocity", 743155724)
...
proc applyCentralImpulse*(self: RigidBody2D; impulse: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "apply_central_impulse", 3862383994)
...
proc applyImpulse*(self: RigidBody2D; impulse: Vector2; position: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "apply_impulse", 4288681949)
  methodbind.ptrcall(self, [getPtr impulse, getPtr position], void)

proc applyTorqueImpulse*(self: RigidBody2D; torque: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "apply_torque_impulse", 373806689)
  methodbind.ptrcall(self, [getPtr torque], void)

proc applyCentralForce*(self: RigidBody2D; force: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "apply_central_force", 743155724)
...
proc applyForce*(self: RigidBody2D; force: Vector2; position: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "apply_force", 4288681949)
  methodbind.ptrcall(self, [getPtr force, getPtr position], void)

proc applyTorque*(self: RigidBody2D; torque: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "apply_torque", 373806689)
  methodbind.ptrcall(self, [getPtr torque], void)

proc addConstantCentralForce*(self: RigidBody2D; force: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "add_constant_central_force", 743155724)
  methodbind.ptrcall(self, [getPtr force], void)

proc addConstantForce*(self: RigidBody2D; force: Vector2; position: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "add_constant_force", 4288681949)
  methodbind.ptrcall(self, [getPtr force, getPtr position], void)

proc addConstantTorque*(self: RigidBody2D; torque: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "add_constant_torque", 373806689)
  methodbind.ptrcall(self, [getPtr torque], void)

proc setConstantForce*(self: RigidBody2D; force: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_constant_force", 743155724)
  methodbind.ptrcall(self, [getPtr force], void)

proc getConstantForce*(self: RigidBody2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_constant_force", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc setConstantTorque*(self: RigidBody2D; torque: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_constant_torque", 373806689)
  methodbind.ptrcall(self, [getPtr torque], void)

proc getConstantTorque*(self: RigidBody2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_constant_torque", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setSleeping*(self: RigidBody2D; sleeping: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_sleeping", 2586408642)
  methodbind.ptrcall(self, [getPtr sleeping], void)

proc isSleeping*(self: RigidBody2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "is_sleeping", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setCanSleep*(self: RigidBody2D; ableToSleep: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_can_sleep", 2586408642)
  methodbind.ptrcall(self, [getPtr ableToSleep], void)

proc isAbleToSleep*(self: RigidBody2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "is_able_to_sleep", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setLockRotationEnabled*(self: RigidBody2D; lockRotation: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_lock_rotation_enabled", 2586408642)
  methodbind.ptrcall(self, [getPtr lockRotation], void)

proc isLockRotationEnabled*(self: RigidBody2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "is_lock_rotation_enabled", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setFreezeEnabled*(self: RigidBody2D; freezeMode: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_freeze_enabled", 2586408642)
  methodbind.ptrcall(self, [getPtr freezeMode], void)

proc isFreezeEnabled*(self: RigidBody2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "is_freeze_enabled", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setFreezeMode*(self: RigidBody2D; freezeMode: RigidBody2D_FreezeMode): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "set_freeze_mode", 1705112154)
  methodbind.ptrcall(self, [getPtr freezeMode], void)

proc getFreezeMode*(self: RigidBody2D): RigidBody2D_FreezeMode =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_freeze_mode", 2016872314)
  methodbind.ptrcall(self, [], RigidBody2D_FreezeMode)

proc getCollidingBodies*(self: RigidBody2D): TypedArray[Node2D] =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className RigidBody2D, "get_colliding_bodies", 3995934104)
