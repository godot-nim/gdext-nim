...
expandOnClassImported(VisualShaderNodeCustom, VisualShaderNode)
...
proc registerVirtual_getCategory*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_category"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getReturnIconType*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_return_icon_type"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getInputPortCount*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_input_port_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getInputPortType*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_input_port_type"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getInputPortName*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_input_port_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getInputPortDefaultValue*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_input_port_default_value"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getDefaultInputPort*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_default_input_port"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOutputPortCount*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_output_port_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOutputPortType*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_output_port_type"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOutputPortName*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_output_port_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPropertyCount*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_property_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPropertyName*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_property_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPropertyDefaultIndex*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_property_default_index"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getFuncCode*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_func_code"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getGlobalCode*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_global_code"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isHighend*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_is_highend"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isAvailable*[T: VisualShaderNodeCustom](Self: typedesc[T]) =
  Self.vmethods[newStringName"_is_available"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
