...
proc registerVirtual_getConnectionState*[T: WebRTCPeerConnectionExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_connection_state"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getGatheringState*[T: WebRTCPeerConnectionExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_gathering_state"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getSignalingState*[T: WebRTCPeerConnectionExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_signaling_state"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_createDataChannel*[T: WebRTCPeerConnectionExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_create_data_channel"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_createOffer*[T: WebRTCPeerConnectionExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_create_offer"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setRemoteDescription*[T: WebRTCPeerConnectionExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_remote_description"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setLocalDescription*[T: WebRTCPeerConnectionExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_local_description"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_addIceCandidate*[T: WebRTCPeerConnectionExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_add_ice_candidate"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
