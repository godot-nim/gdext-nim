...
proc registerVirtual_getType*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_type"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getExtension*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_extension"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getReservedWords*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_reserved_words"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isControlFlowKeyword*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_control_flow_keyword"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getCommentDelimiters*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_comment_delimiters"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getDocCommentDelimiters*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_doc_comment_delimiters"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getStringDelimiters*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_string_delimiters"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_makeTemplate*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_make_template"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getBuiltInTemplates*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_built_in_templates"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isUsingTemplates*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_using_templates"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_validate*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_validate"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_validatePath*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_validate_path"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_createScript*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_create_script"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_hasNamedClasses*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_has_named_classes"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_supportsBuiltinMode*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_supports_builtin_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_supportsDocumentation*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_supports_documentation"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_canInheritFromFile*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_can_inherit_from_file"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_findFunction*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_find_function"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_makeFunction*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_make_function"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_canMakeFunction*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_can_make_function"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_openInExternalEditor*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_open_in_external_editor"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_overridesExternalEditor*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_overrides_external_editor"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_preferredFileNameCasing*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_preferred_file_name_casing"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_completeCode*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_complete_code"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_lookupCode*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_lookup_code"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_autoIndentCode*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_auto_indent_code"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_addGlobalConstant*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_add_global_constant"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_addNamedGlobalConstant*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_add_named_global_constant"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_removeNamedGlobalConstant*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_remove_named_global_constant"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_threadEnter*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_thread_enter"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_threadExit*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_thread_exit"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetError*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_error"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetStackLevelCount*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_stack_level_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetStackLevelLine*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_stack_level_line"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetStackLevelFunction*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_stack_level_function"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetStackLevelSource*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_stack_level_source"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetStackLevelLocals*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_stack_level_locals"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetStackLevelMembers*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_stack_level_members"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetStackLevelInstance*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_stack_level_instance"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetGlobals*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_globals"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugParseStackLevelExpression*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_parse_stack_level_expression"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_debugGetCurrentStackInfo*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_debug_get_current_stack_info"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_reloadAllScripts*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_reload_all_scripts"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_reloadScripts*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_reload_scripts"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_reloadToolScript*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_reload_tool_script"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPublicFunctions*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_public_functions"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPublicConstants*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_public_constants"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPublicAnnotations*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_public_annotations"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_profilingStart*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_profiling_start"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_profilingStop*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_profiling_stop"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_profilingSetSaveNativeCalls*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_profiling_set_save_native_calls"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_profilingGetAccumulatedData*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_profiling_get_accumulated_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_profilingGetFrameData*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_profiling_get_frame_data"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_frame*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_frame"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_handlesGlobalClassType*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_handles_global_class_type"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getGlobalClassName*[T: ScriptLanguageExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_global_class_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
