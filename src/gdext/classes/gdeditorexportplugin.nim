...
proc registerVirtual_exportFile*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_export_file"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_exportBegin*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_export_begin"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_exportEnd*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_export_end"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_beginCustomizeResources*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_begin_customize_resources"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_customizeResource*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_customize_resource"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_beginCustomizeScenes*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_begin_customize_scenes"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_customizeScene*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_customize_scene"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getCustomizationConfigurationHash*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_customization_configuration_hash"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_endCustomizeScenes*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_end_customize_scenes"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_endCustomizeResources*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_end_customize_resources"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getExportOptionsOverrides*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_export_options_overrides"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getExportFeatures*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_export_features"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_supportsPlatform*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_supports_platform"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAndroidDependencies*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_android_dependencies"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAndroidDependenciesMavenRepos*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_android_dependencies_maven_repos"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAndroidLibraries*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_android_libraries"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAndroidManifestActivityElementContents*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_android_manifest_activity_element_contents"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAndroidManifestApplicationElementContents*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_android_manifest_application_element_contents"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAndroidManifestElementContents*[T: EditorExportPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_android_manifest_element_contents"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
