...
proc setEmitting*(self: CPUParticles2D; emitting: bool): void =
  ...
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_emitting", 2586408642)
  methodbind.ptrcall(self, [getPtr emitting], void)

proc setAmount*(self: CPUParticles2D; amount: int32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_amount", 1286410249)
  methodbind.ptrcall(self, [getPtr amount], void)

proc setLifetime*(self: CPUParticles2D; secs: float64): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_lifetime", 373806689)
  methodbind.ptrcall(self, [getPtr secs], void)

proc setOneShot*(self: CPUParticles2D; enable: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_one_shot", 2586408642)
  methodbind.ptrcall(self, [getPtr enable], void)

proc setPreProcessTime*(self: CPUParticles2D; secs: float64): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_pre_process_time", 373806689)
  methodbind.ptrcall(self, [getPtr secs], void)

proc setExplosivenessRatio*(self: CPUParticles2D; ratio: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_explosiveness_ratio", 373806689)
  methodbind.ptrcall(self, [getPtr ratio], void)

proc setRandomnessRatio*(self: CPUParticles2D; ratio: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_randomness_ratio", 373806689)
  methodbind.ptrcall(self, [getPtr ratio], void)

proc setLifetimeRandomness*(self: CPUParticles2D; random: float64): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_lifetime_randomness", 373806689)
  methodbind.ptrcall(self, [getPtr random], void)

proc setUseLocalCoordinates*(self: CPUParticles2D; enable: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_use_local_coordinates", 2586408642)
  methodbind.ptrcall(self, [getPtr enable], void)

proc setFixedFps*(self: CPUParticles2D; fps: int32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_fixed_fps", 1286410249)
  methodbind.ptrcall(self, [getPtr fps], void)

proc setFractionalDelta*(self: CPUParticles2D; enable: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_fractional_delta", 2586408642)
  methodbind.ptrcall(self, [getPtr enable], void)

proc setSpeedScale*(self: CPUParticles2D; scale: float64): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_speed_scale", 373806689)
  methodbind.ptrcall(self, [getPtr scale], void)

proc requestParticlesProcess*(self: CPUParticles2D; processTime: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "request_particles_process", 373806689)
  methodbind.ptrcall(self, [getPtr processTime], void)

proc isEmitting*(self: CPUParticles2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "is_emitting", 36873697)
  methodbind.ptrcall(self, [], bool)

proc getAmount*(self: CPUParticles2D): int32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_amount", 3905245786)
  methodbind.ptrcall(self, [], int32)

proc getLifetime*(self: CPUParticles2D): float64 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_lifetime", 1740695150)
  methodbind.ptrcall(self, [], float64)

proc getOneShot*(self: CPUParticles2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_one_shot", 36873697)
  methodbind.ptrcall(self, [], bool)

proc getPreProcessTime*(self: CPUParticles2D): float64 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_pre_process_time", 1740695150)
  methodbind.ptrcall(self, [], float64)

proc getExplosivenessRatio*(self: CPUParticles2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_explosiveness_ratio", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc getRandomnessRatio*(self: CPUParticles2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_randomness_ratio", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc getLifetimeRandomness*(self: CPUParticles2D): float64 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_lifetime_randomness", 1740695150)
  methodbind.ptrcall(self, [], float64)

proc getUseLocalCoordinates*(self: CPUParticles2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_use_local_coordinates", 36873697)
  methodbind.ptrcall(self, [], bool)

proc getFixedFps*(self: CPUParticles2D): int32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_fixed_fps", 3905245786)
  methodbind.ptrcall(self, [], int32)

proc getFractionalDelta*(self: CPUParticles2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_fractional_delta", 36873697)
  methodbind.ptrcall(self, [], bool)

proc getSpeedScale*(self: CPUParticles2D): float64 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_speed_scale", 1740695150)
  methodbind.ptrcall(self, [], float64)

proc setUseFixedSeed*(self: CPUParticles2D; useFixedSeed: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_use_fixed_seed", 2586408642)
  methodbind.ptrcall(self, [getPtr useFixedSeed], void)

proc getUseFixedSeed*(self: CPUParticles2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_use_fixed_seed", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setSeed*(self: CPUParticles2D; seed: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_seed", 1286410249)
  methodbind.ptrcall(self, [getPtr seed], void)

proc getSeed*(self: CPUParticles2D): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_seed", 3905245786)
  methodbind.ptrcall(self, [], uint32)

proc setDrawOrder*(self: CPUParticles2D; order: CPUParticles2D_DrawOrder): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_draw_order", 4183193490)
  methodbind.ptrcall(self, [getPtr order], void)

proc getDrawOrder*(self: CPUParticles2D): CPUParticles2D_DrawOrder =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_draw_order", 1668655735)
  methodbind.ptrcall(self, [], CPUParticles2D_DrawOrder)

proc setTexture*(self: CPUParticles2D; texture: gdref Texture2D): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_texture", 4051416890)
  methodbind.ptrcall(self, [getPtr texture], void)

proc getTexture*(self: CPUParticles2D): gdref Texture2D =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_texture", 3635182373)
  methodbind.ptrcall(self, [], gdref Texture2D)

proc restart*(self: CPUParticles2D; keepSeed: bool = false): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "restart", 107499316)
  methodbind.ptrcall(self, [getPtr keepSeed], void)

proc setDirection*(self: CPUParticles2D; direction: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_direction", 743155724)
  methodbind.ptrcall(self, [getPtr direction], void)

proc getDirection*(self: CPUParticles2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_direction", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc setSpread*(self: CPUParticles2D; spread: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_spread", 373806689)
  methodbind.ptrcall(self, [getPtr spread], void)

proc getSpread*(self: CPUParticles2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_spread", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setParamMin*(self: CPUParticles2D; param: CPUParticles2D_Parameter; value: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_param_min", 3320615296)
...
proc getParamMin*(self: CPUParticles2D; param: CPUParticles2D_Parameter): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_param_min", 2038050600)
...
proc setParamMax*(self: CPUParticles2D; param: CPUParticles2D_Parameter; value: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_param_max", 3320615296)
  methodbind.ptrcall(self, [getPtr param, getPtr value], void)

proc getParamMax*(self: CPUParticles2D; param: CPUParticles2D_Parameter): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_param_max", 2038050600)
  methodbind.ptrcall(self, [getPtr param], Float)

proc setParamCurve*(self: CPUParticles2D; param: CPUParticles2D_Parameter; curve: gdref Curve): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_param_curve", 2959350143)
...
proc getParamCurve*(self: CPUParticles2D; param: CPUParticles2D_Parameter): gdref Curve =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_param_curve", 2603158474)
  methodbind.ptrcall(self, [getPtr param], gdref Curve)

proc setColor*(self: CPUParticles2D; color: Color): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_color", 2920490490)
  methodbind.ptrcall(self, [getPtr color], void)

proc getColor*(self: CPUParticles2D): Color =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_color", 3444240500)
  methodbind.ptrcall(self, [], Color)

proc setColorRamp*(self: CPUParticles2D; ramp: gdref Gradient): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_color_ramp", 2756054477)
  methodbind.ptrcall(self, [getPtr ramp], void)

proc getColorRamp*(self: CPUParticles2D): gdref Gradient =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_color_ramp", 132272999)
  methodbind.ptrcall(self, [], gdref Gradient)

proc setColorInitialRamp*(self: CPUParticles2D; ramp: gdref Gradient): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_color_initial_ramp", 2756054477)
  methodbind.ptrcall(self, [getPtr ramp], void)

proc getColorInitialRamp*(self: CPUParticles2D): gdref Gradient =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_color_initial_ramp", 132272999)
  methodbind.ptrcall(self, [], gdref Gradient)

proc setParticleFlag*(self: CPUParticles2D; particleFlag: CPUParticles2D_ParticleFlags; enable: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_particle_flag", 4178137949)
...
proc getParticleFlag*(self: CPUParticles2D; particleFlag: CPUParticles2D_ParticleFlags): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_particle_flag", 2829976507)
...
proc setEmissionShape*(self: CPUParticles2D; shape: CPUParticles2D_EmissionShape): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_emission_shape", 393763892)
  methodbind.ptrcall(self, [getPtr shape], void)

proc getEmissionShape*(self: CPUParticles2D): CPUParticles2D_EmissionShape =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_emission_shape", 1740246024)
  methodbind.ptrcall(self, [], CPUParticles2D_EmissionShape)

proc setEmissionSphereRadius*(self: CPUParticles2D; radius: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_emission_sphere_radius", 373806689)
  methodbind.ptrcall(self, [getPtr radius], void)

proc getEmissionSphereRadius*(self: CPUParticles2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_emission_sphere_radius", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setEmissionRectExtents*(self: CPUParticles2D; extents: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_emission_rect_extents", 743155724)
  methodbind.ptrcall(self, [getPtr extents], void)

proc getEmissionRectExtents*(self: CPUParticles2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_emission_rect_extents", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc setEmissionPoints*(self: CPUParticles2D; array: PackedVector2Array): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_emission_points", 1509147220)
  methodbind.ptrcall(self, [getPtr array], void)

proc getEmissionPoints*(self: CPUParticles2D): PackedVector2Array =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_emission_points", 2961356807)
  methodbind.ptrcall(self, [], PackedVector2Array)

proc setEmissionNormals*(self: CPUParticles2D; array: PackedVector2Array): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_emission_normals", 1509147220)
  methodbind.ptrcall(self, [getPtr array], void)

proc getEmissionNormals*(self: CPUParticles2D): PackedVector2Array =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_emission_normals", 2961356807)
  methodbind.ptrcall(self, [], PackedVector2Array)

proc setEmissionColors*(self: CPUParticles2D; array: PackedColorArray): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_emission_colors", 3546319833)
  methodbind.ptrcall(self, [getPtr array], void)

proc getEmissionColors*(self: CPUParticles2D): PackedColorArray =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_emission_colors", 1392750486)
  methodbind.ptrcall(self, [], PackedColorArray)

proc getGravity*(self: CPUParticles2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_gravity", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc setGravity*(self: CPUParticles2D; accelVec: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_gravity", 743155724)
  methodbind.ptrcall(self, [getPtr accelVec], void)

proc getSplitScale*(self: CPUParticles2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_split_scale", 2240911060)
  methodbind.ptrcall(self, [], bool)

proc setSplitScale*(self: CPUParticles2D; splitScale: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_split_scale", 2586408642)
  methodbind.ptrcall(self, [getPtr splitScale], void)

proc getScaleCurveX*(self: CPUParticles2D): gdref Curve =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_scale_curve_x", 2460114913)
  methodbind.ptrcall(self, [], gdref Curve)

proc setScaleCurveX*(self: CPUParticles2D; scaleCurve: gdref Curve): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_scale_curve_x", 270443179)
  methodbind.ptrcall(self, [getPtr scaleCurve], void)

proc getScaleCurveY*(self: CPUParticles2D): gdref Curve =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "get_scale_curve_y", 2460114913)
  methodbind.ptrcall(self, [], gdref Curve)

proc setScaleCurveY*(self: CPUParticles2D; scaleCurve: gdref Curve): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "set_scale_curve_y", 270443179)
  methodbind.ptrcall(self, [getPtr scaleCurve], void)

proc convertFromParticles*(self: CPUParticles2D; particles: Node): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className CPUParticles2D, "convert_from_particles", 1078189570)
