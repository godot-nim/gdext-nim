...
proc registerVirtual_getPresetFeatures*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_preset_features"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isExecutable*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_executable"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getExportOptions*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_export_options"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shouldUpdateExportOptions*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_should_update_export_options"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getExportOptionVisibility*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_export_option_visibility"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getExportOptionWarning*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_export_option_warning"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOsName*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_os_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getLogo*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_logo"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_pollExport*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_poll_export"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOptionsCount*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_options_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOptionsTooltip*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_options_tooltip"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOptionIcon*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_option_icon"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOptionLabel*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_option_label"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getOptionTooltip*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_option_tooltip"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getDeviceArchitecture*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_device_architecture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getRunIcon*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_run_icon"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_canExport*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_can_export"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_hasValidExportConfiguration*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_has_valid_export_configuration"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_hasValidProjectConfiguration*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_has_valid_project_configuration"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getBinaryExtensions*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_binary_extensions"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_exportProject*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_export_project"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_exportPack*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_export_pack"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_exportZip*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_export_zip"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_exportPackPatch*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_export_pack_patch"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_exportZipPatch*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_export_zip_patch"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPlatformFeatures*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_platform_features"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getDebugProtocol*[T: EditorExportPlatformExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_debug_protocol"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
