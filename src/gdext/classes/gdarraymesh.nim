...
proc addSurfaceFromArrays*(self: ArrayMesh; primitive: Mesh_PrimitiveType; arrays: Array[Variant]; blendShapes: Array[Array[Variant]] = newArray[Array[Variant]](); lods: Dictionary[Variant, Variant] = newDictionary[Variant, Variant](); flags: set[Mesh_ArrayFormat] = {}): void =
