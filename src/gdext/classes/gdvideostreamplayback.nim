...
proc registerVirtual_play*[T: VideoStreamPlayback](Self: typedesc[T]) =
  Self.vmethods[stringName"_play"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setPaused*[T: VideoStreamPlayback](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_paused"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_isPaused*[T: VideoStreamPlayback](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_paused"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setAudioTrack*[T: VideoStreamPlayback](Self: typedesc[T]) =
  Self.vmethods[stringName"_set_audio_track"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getTexture*[T: VideoStreamPlayback](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_texture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_update*[T: VideoStreamPlayback](Self: typedesc[T]) =
  Self.vmethods[stringName"_update"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getChannels*[T: VideoStreamPlayback](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_channels"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getMixRate*[T: VideoStreamPlayback](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_mix_rate"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
