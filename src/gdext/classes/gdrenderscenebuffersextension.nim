...
proc registerVirtual_setFsrSharpness*[T: RenderSceneBuffersExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_set_fsr_sharpness"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setTextureMipmapBias*[T: RenderSceneBuffersExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_set_texture_mipmap_bias"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setAnisotropicFilteringLevel*[T: RenderSceneBuffersExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_set_anisotropic_filtering_level"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_setUseDebanding*[T: RenderSceneBuffersExtension](Self: typedesc[T]) =
  Self.vmethods[newStringName"_set_use_debanding"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
