...
proc registerVirtual_setupSession*[T: EditorDebuggerPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_setup_session"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_hasCapture*[T: EditorDebuggerPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_has_capture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_capture*[T: EditorDebuggerPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_capture"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_gotoScriptLine*[T: EditorDebuggerPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_goto_script_line"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_breakpointsClearedInTree*[T: EditorDebuggerPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_breakpoints_cleared_in_tree"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_breakpointSetInTree*[T: EditorDebuggerPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_breakpoint_set_in_tree"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
