...
proc registerVirtual_canHandle*[T: EditorInspectorPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_can_handle"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_parseBegin*[T: EditorInspectorPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_parse_begin"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_parseCategory*[T: EditorInspectorPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_parse_category"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_parseGroup*[T: EditorInspectorPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_parse_group"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_parseProperty*[T: EditorInspectorPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_parse_property"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_parseEnd*[T: EditorInspectorPlugin](Self: typedesc[T]) =
  Self.vmethods[stringName"_parse_end"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
