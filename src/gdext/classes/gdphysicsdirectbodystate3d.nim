...
proc setCollisionLayer*(self: PhysicsDirectBodyState3D; layer: uint32): void =
  expandMethodBind(className PhysicsDirectBodyState3D, "set_collision_layer", 1286410249)
  methodbind.ptrcall(self, [getPtr layer])

proc getCollisionLayer*(self: PhysicsDirectBodyState3D): uint32 =
  expandMethodBind(className PhysicsDirectBodyState3D, "get_collision_layer", 3905245786)
  var ret: encoded uint32
  methodbind.ptrcall(self, [], addr ret)
  (addr ret).decode_result(uint32)

proc setCollisionMask*(self: PhysicsDirectBodyState3D; mask: uint32): void =
  expandMethodBind(className PhysicsDirectBodyState3D, "set_collision_mask", 1286410249)
  methodbind.ptrcall(self, [getPtr mask])

proc getCollisionMask*(self: PhysicsDirectBodyState3D): uint32 =
  expandMethodBind(className PhysicsDirectBodyState3D, "get_collision_mask", 3905245786)
  var ret: encoded uint32
  methodbind.ptrcall(self, [], addr ret)
  (addr ret).decode_result(uint32)
