...
expandOnClassImported(PhysicsDirectBodyState2D, Object)

proc getTotalGravity*(self: PhysicsDirectBodyState2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_total_gravity", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc getTotalLinearDamp*(self: PhysicsDirectBodyState2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_total_linear_damp", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc getTotalAngularDamp*(self: PhysicsDirectBodyState2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_total_angular_damp", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc getCenterOfMass*(self: PhysicsDirectBodyState2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_center_of_mass", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc getCenterOfMassLocal*(self: PhysicsDirectBodyState2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_center_of_mass_local", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc getInverseMass*(self: PhysicsDirectBodyState2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_inverse_mass", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc getInverseInertia*(self: PhysicsDirectBodyState2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_inverse_inertia", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setLinearVelocity*(self: PhysicsDirectBodyState2D; velocity: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "set_linear_velocity", 743155724)
  methodbind.ptrcall(self, [getPtr velocity], void)

proc getLinearVelocity*(self: PhysicsDirectBodyState2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_linear_velocity", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc setAngularVelocity*(self: PhysicsDirectBodyState2D; velocity: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "set_angular_velocity", 373806689)
  methodbind.ptrcall(self, [getPtr velocity], void)

proc getAngularVelocity*(self: PhysicsDirectBodyState2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_angular_velocity", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setTransform*(self: PhysicsDirectBodyState2D; transform: Transform2D): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "set_transform", 2761652528)
  methodbind.ptrcall(self, [getPtr transform], void)

proc getTransform*(self: PhysicsDirectBodyState2D): Transform2D =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_transform", 3814499831)
...
proc getVelocityAtLocalPosition*(self: PhysicsDirectBodyState2D; localPosition: Vector2): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_velocity_at_local_position", 2656412154)
  methodbind.ptrcall(self, [getPtr localPosition], Vector2)

proc applyCentralImpulse*(self: PhysicsDirectBodyState2D; impulse: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "apply_central_impulse", 743155724)
  methodbind.ptrcall(self, [getPtr impulse], void)

proc applyTorqueImpulse*(self: PhysicsDirectBodyState2D; impulse: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "apply_torque_impulse", 373806689)
  methodbind.ptrcall(self, [getPtr impulse], void)

proc applyImpulse*(self: PhysicsDirectBodyState2D; impulse: Vector2; position: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "apply_impulse", 4288681949)
...
proc applyCentralForce*(self: PhysicsDirectBodyState2D; force: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "apply_central_force", 3862383994)
...
proc applyForce*(self: PhysicsDirectBodyState2D; force: Vector2; position: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "apply_force", 4288681949)
...
proc applyTorque*(self: PhysicsDirectBodyState2D; torque: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "apply_torque", 373806689)
...
proc addConstantCentralForce*(self: PhysicsDirectBodyState2D; force: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "add_constant_central_force", 3862383994)
  methodbind.ptrcall(self, [getPtr force], void)

proc addConstantForce*(self: PhysicsDirectBodyState2D; force: Vector2; position: Vector2 = vector2(0, 0)): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "add_constant_force", 4288681949)
  methodbind.ptrcall(self, [getPtr force, getPtr position], void)

proc addConstantTorque*(self: PhysicsDirectBodyState2D; torque: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "add_constant_torque", 373806689)
  methodbind.ptrcall(self, [getPtr torque], void)

proc setConstantForce*(self: PhysicsDirectBodyState2D; force: Vector2): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "set_constant_force", 743155724)
  methodbind.ptrcall(self, [getPtr force], void)

proc getConstantForce*(self: PhysicsDirectBodyState2D): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_constant_force", 3341600327)
  methodbind.ptrcall(self, [], Vector2)

proc setConstantTorque*(self: PhysicsDirectBodyState2D; torque: Float): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "set_constant_torque", 373806689)
  methodbind.ptrcall(self, [getPtr torque], void)

proc getConstantTorque*(self: PhysicsDirectBodyState2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_constant_torque", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc setSleepState*(self: PhysicsDirectBodyState2D; enabled: bool): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "set_sleep_state", 2586408642)
  methodbind.ptrcall(self, [getPtr enabled], void)

proc isSleeping*(self: PhysicsDirectBodyState2D): bool =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "is_sleeping", 36873697)
  methodbind.ptrcall(self, [], bool)

proc setCollisionLayer*(self: PhysicsDirectBodyState2D; layer: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "set_collision_layer", 1286410249)
  methodbind.ptrcall(self, [getPtr layer], void)

proc getCollisionLayer*(self: PhysicsDirectBodyState2D): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_collision_layer", 3905245786)
  methodbind.ptrcall(self, [], uint32)

proc setCollisionMask*(self: PhysicsDirectBodyState2D; mask: uint32): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "set_collision_mask", 1286410249)
  methodbind.ptrcall(self, [getPtr mask], void)

proc getCollisionMask*(self: PhysicsDirectBodyState2D): uint32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_collision_mask", 3905245786)
  methodbind.ptrcall(self, [], uint32)

proc getContactCount*(self: PhysicsDirectBodyState2D): int32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_count", 3905245786)
  methodbind.ptrcall(self, [], int32)

proc getContactLocalPosition*(self: PhysicsDirectBodyState2D; contactIdx: int32): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_local_position", 2299179447)
  methodbind.ptrcall(self, [getPtr contactIdx], Vector2)

proc getContactLocalNormal*(self: PhysicsDirectBodyState2D; contactIdx: int32): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_local_normal", 2299179447)
  methodbind.ptrcall(self, [getPtr contactIdx], Vector2)

proc getContactLocalShape*(self: PhysicsDirectBodyState2D; contactIdx: int32): int32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_local_shape", 923996154)
...
proc getContactLocalVelocityAtPosition*(self: PhysicsDirectBodyState2D; contactIdx: int32): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_local_velocity_at_position", 2299179447)
  methodbind.ptrcall(self, [getPtr contactIdx], Vector2)

proc getContactCollider*(self: PhysicsDirectBodyState2D; contactIdx: int32): RID =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_collider", 495598643)
...
proc getContactColliderPosition*(self: PhysicsDirectBodyState2D; contactIdx: int32): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_collider_position", 2299179447)
  methodbind.ptrcall(self, [getPtr contactIdx], Vector2)

proc getContactColliderId*(self: PhysicsDirectBodyState2D; contactIdx: int32): uint64 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_collider_id", 923996154)
...
proc getContactColliderObject*(self: PhysicsDirectBodyState2D; contactIdx: int32): Object =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_collider_object", 3332903315)
...
proc getContactColliderShape*(self: PhysicsDirectBodyState2D; contactIdx: int32): int32 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_collider_shape", 923996154)
  methodbind.ptrcall(self, [getPtr contactIdx], int32)

proc getContactColliderVelocityAtPosition*(self: PhysicsDirectBodyState2D; contactIdx: int32): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_collider_velocity_at_position", 2299179447)
  methodbind.ptrcall(self, [getPtr contactIdx], Vector2)

proc getContactImpulse*(self: PhysicsDirectBodyState2D; contactIdx: int32): Vector2 =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_contact_impulse", 2299179447)
  methodbind.ptrcall(self, [getPtr contactIdx], Vector2)

proc getStep*(self: PhysicsDirectBodyState2D): Float =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_step", 1740695150)
  methodbind.ptrcall(self, [], Float)

proc integrateForces*(self: PhysicsDirectBodyState2D): void =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "integrate_forces", 3218959716)
  methodbind.ptrcall(self, [], void)

proc getSpaceState*(self: PhysicsDirectBodyState2D): PhysicsDirectSpaceState2D =
  var methodbind {.global.}: MethodBindPtr
  if unlikely(methodbind.isNil):
    methodbind = ClassDB.getMethodBind(className PhysicsDirectBodyState2D, "get_space_state", 2506717822)
