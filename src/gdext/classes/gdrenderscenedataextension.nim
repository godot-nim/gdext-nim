...
proc registerVirtual_getCamTransform*[T: RenderSceneDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_cam_transform"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getCamProjection*[T: RenderSceneDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_cam_projection"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getViewEyeOffset*[T: RenderSceneDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_view_eye_offset"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getViewProjection*[T: RenderSceneDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_view_projection"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getUniformBuffer*[T: RenderSceneDataExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_uniform_buffer"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
