...
proc registerVirtual_segmentShapeCreate*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_segment_shape_create"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_circleShapeCreate*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_circle_shape_create"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_rectangleShapeCreate*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_rectangle_shape_create"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_shapeCollide*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_shape_collide"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_areaAttachCanvasInstanceId*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_area_attach_canvas_instance_id"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_areaGetCanvasInstanceId*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_area_get_canvas_instance_id"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_areaSetPickable*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_area_set_pickable"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_bodySetShapeAsOneWayCollision*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_body_set_shape_as_one_way_collision"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_bodyAttachCanvasInstanceId*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_body_attach_canvas_instance_id"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_bodyGetCanvasInstanceId*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_body_get_canvas_instance_id"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_bodySetContinuousCollisionDetectionMode*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_body_set_continuous_collision_detection_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_bodyGetContinuousCollisionDetectionMode*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_body_get_continuous_collision_detection_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_bodyCollideShape*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_body_collide_shape"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_bodySetPickable*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_body_set_pickable"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_jointSetParam*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_joint_set_param"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_jointGetParam*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_joint_get_param"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_jointMakeGroove*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_joint_make_groove"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_jointMakeDampedSpring*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_joint_make_damped_spring"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_pinJointSetFlag*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_pin_joint_set_flag"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_pinJointGetFlag*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_pin_joint_get_flag"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_dampedSpringJointSetParam*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_damped_spring_joint_set_param"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_dampedSpringJointGetParam*[T: PhysicsServer2DExtension](Self: typedesc[T]) =
  Self.vmethods[stringName"_damped_spring_joint_get_param"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
