...
proc registerVirtual_getVisibleName*[T: EditorImportPlugin](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_visible_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPresetCount*[T: EditorImportPlugin](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_preset_count"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getPresetName*[T: EditorImportPlugin](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_preset_name"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getSaveExtension*[T: EditorImportPlugin](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_save_extension"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getImportOrder*[T: EditorImportPlugin](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_import_order"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
