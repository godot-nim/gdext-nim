...
proc registerVirtual_toggle*[T: EngineProfiler](Self: typedesc[T]) =
  Self.vmethods[stringName"_toggle"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_addFrame*[T: EngineProfiler](Self: typedesc[T]) =
  Self.vmethods[stringName"_add_frame"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_tick*[T: EngineProfiler](Self: typedesc[T]) =
  Self.vmethods[stringName"_tick"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
