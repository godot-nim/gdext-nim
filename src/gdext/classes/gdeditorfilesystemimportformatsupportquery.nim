...
proc registerVirtual_isActive*[T: EditorFileSystemImportFormatSupportQuery](Self: typedesc[T]) =
  Self.vmethods[stringName"_is_active"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getFileExtensions*[T: EditorFileSystemImportFormatSupportQuery](Self: typedesc[T]) =
  Self.vmethods[stringName"_get_file_extensions"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_query*[T: EditorFileSystemImportFormatSupportQuery](Self: typedesc[T]) =
  Self.vmethods[stringName"_query"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
