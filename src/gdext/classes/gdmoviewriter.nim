...
proc registerVirtual_getAudioMixRate*[T: MovieWriter](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_audio_mix_rate"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_getAudioSpeakerMode*[T: MovieWriter](Self: typedesc[T]) =
  Self.vmethods[newStringName"_get_audio_speaker_mode"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_handlesFile*[T: MovieWriter](Self: typedesc[T]) =
  Self.vmethods[newStringName"_handles_file"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_writeBegin*[T: MovieWriter](Self: typedesc[T]) =
  Self.vmethods[newStringName"_write_begin"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_writeFrame*[T: MovieWriter](Self: typedesc[T]) =
  Self.vmethods[newStringName"_write_frame"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
...
proc registerVirtual_writeEnd*[T: MovieWriter](Self: typedesc[T]) =
  Self.vmethods[newStringName"_write_end"] = proc (p_instance: ClassInstancePtr; p_args: ptr UncheckedArray[ConstTypePtr]; r_ret: TypePtr) {.gdcall.} =
