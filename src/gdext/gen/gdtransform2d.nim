...
# `in(Transform2D Dictionary)`
# `in(Transform2D Array)`
var `*(Transform2D PackedVector2Array)`: PtrOperatorEvaluator
func `not`*(left: Transform2D): bool = {.noSideEffect.}: `not(Transform2D)`(getPtr left, nil, addr result)
func `*`*(left: Transform2D; right: Int): Transform2D = {.noSideEffect.}: `*(Transform2D Int)`(getPtr left, getPtr right, addr result)
func `/`*(left: Transform2D; right: Int): Transform2D = {.noSideEffect.}: `/(Transform2D Int)`(getPtr left, getPtr right, addr result)
func `*`*(left: Transform2D; right: Float): Transform2D = {.noSideEffect.}: `*(Transform2D Float)`(getPtr left, getPtr right, addr result)
func `/`*(left: Transform2D; right: Float): Transform2D = {.noSideEffect.}: `/(Transform2D Float)`(getPtr left, getPtr right, addr result)
func `*`*(left: Transform2D; right: Vector2): Vector2 = {.noSideEffect.}: `*(Transform2D Vector2)`(getPtr left, getPtr right, addr result)
func `*`*(left: Transform2D; right: Rect2): Rect2 = {.noSideEffect.}: `*(Transform2D Rect2)`(getPtr left, getPtr right, addr result)
func `*`*(left: Transform2D; right: Transform2D): Transform2D = {.noSideEffect.}: `*(Transform2D Transform2D)`(getPtr left, getPtr right, addr result)
func `*`*(left: Transform2D; right: PackedVector2Array): PackedVector2Array = {.noSideEffect.}: `*(Transform2D PackedVector2Array)`(getPtr left, getPtr right, addr result)
proc load_Transform2D_operators {.execon: staticevents.init_engine.on_load_builtinclassOperator.} =
  `not(Transform2D)` = load(opNot, VariantType_Transform2D, VariantType_Nil)
  `*(Transform2D Int)` = load(opMultiply, VariantType_Transform2D, VariantType_Int)
  `/(Transform2D Int)` = load(opDivide, VariantType_Transform2D, VariantType_Int)
  `*(Transform2D Float)` = load(opMultiply, VariantType_Transform2D, VariantType_Float)
  `/(Transform2D Float)` = load(opDivide, VariantType_Transform2D, VariantType_Float)
  `*(Transform2D Vector2)` = load(opMultiply, VariantType_Transform2D, VariantType_Vector2)
  `*(Transform2D Rect2)` = load(opMultiply, VariantType_Transform2D, VariantType_Rect2)
  `*(Transform2D Transform2D)` = load(opMultiply, VariantType_Transform2D, VariantType_Transform2D)
  `*(Transform2D PackedVector2Array)` = load(opMultiply, VariantType_Transform2D, VariantType_PackedVector2Array)
