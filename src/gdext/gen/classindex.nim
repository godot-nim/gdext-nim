type
  ...
  GodotInstance* = ptr object of Object
  ...
  NavigationServer2DManager* = ptr object of Object
  NavigationServer3D* = ptr object of Object
  NavigationServer3DManager* = ptr object of Object
  Node* = ptr object of Object
  OS* = ptr object of Object
  OpenXRExtensionWrapper* = ptr object of Object
  ...
  OpenXRAndroidThreadSettingsExtension* = ptr object of OpenXRExtensionWrapper
  OpenXRExtensionWrapperExtension* = ptr object of OpenXRExtensionWrapper
  OpenXRFrameSynthesisExtension* = ptr object of OpenXRExtensionWrapper
  OpenXRFutureExtension* = ptr object of OpenXRExtensionWrapper
  OpenXRRenderModelExtension* = ptr object of OpenXRExtensionWrapper
  OpenXRSpatialAnchorCapability* = ptr object of OpenXRExtensionWrapper
  OpenXRSpatialEntityExtension* = ptr object of OpenXRExtensionWrapper
  OpenXRSpatialMarkerTrackingCapability* = ptr object of OpenXRExtensionWrapper
  OpenXRSpatialPlaneTrackingCapability* = ptr object of OpenXRExtensionWrapper
  ...
  EditorContextMenuPlugin* = ptr object of RefCounted
  ...
  GLTFObjectModelProperty* = ptr object of RefCounted
  ...
  Logger* = ptr object of RefCounted
  ...
  OpenXRFutureResult* = ptr object of RefCounted
  OpenXRSpatialCapabilityConfigurationBaseHeader* = ptr object of RefCounted
  OpenXRSpatialComponentData* = ptr object of RefCounted
  OpenXRStructureBase* = ptr object of RefCounted
  ...
  ScriptBacktrace* = ptr object of RefCounted
  Semaphore* = ptr object of RefCounted
  SkinReference* = ptr object of RefCounted
  SocketServer* = ptr object of RefCounted
  ...
  GridMapEditorPlugin* = ptr object of EditorPlugin
  ...
  OpenXRRenderModel* = ptr object of Node3D
  OpenXRRenderModelManager* = ptr object of Node3D
  ...
  EditorExportPlatformAppleEmbedded* = ptr object of EditorExportPlatform
  EditorExportPlatformExtension* = ptr object of EditorExportPlatform
  ...
  OpenXRSpatialCapabilityConfigurationAnchor* = ptr object of OpenXRSpatialCapabilityConfigurationBaseHeader
  OpenXRSpatialCapabilityConfigurationAprilTag* = ptr object of OpenXRSpatialCapabilityConfigurationBaseHeader
  OpenXRSpatialCapabilityConfigurationAruco* = ptr object of OpenXRSpatialCapabilityConfigurationBaseHeader
  OpenXRSpatialCapabilityConfigurationMicroQrCode* = ptr object of OpenXRSpatialCapabilityConfigurationBaseHeader
  OpenXRSpatialCapabilityConfigurationPlaneTracking* = ptr object of OpenXRSpatialCapabilityConfigurationBaseHeader
  OpenXRSpatialCapabilityConfigurationQrCode* = ptr object of OpenXRSpatialCapabilityConfigurationBaseHeader
  OpenXRSpatialComponentAnchorList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentBounded2DList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentBounded3DList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentMarkerList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentMesh2DList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentMesh3DList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentParentList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentPersistenceList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentPlaneAlignmentList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentPlaneSemanticLabelList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialComponentPolygon2DList* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialQueryResultData* = ptr object of OpenXRSpatialComponentData
  OpenXRSpatialContextPersistenceConfig* = ptr object of OpenXRStructureBase
  ...
  FoldableGroup* = ptr object of Resource
  ...
  JointLimitation3D* = ptr object of Resource
  ...
  OpenXRBindingModifier* = ptr object of Resource
  ...
  ResourceImporterSVG* = ptr object of ResourceImporter
  ...
  TCPServer* = ptr object of SocketServer
  UDSServer* = ptr object of SocketServer
  ...
  StreamPeerSocket* = ptr object of StreamPeer
  ...
  BoneConstraint3D* = ptr object of SkeletonModifier3D
  BoneTwistDisperser3D* = ptr object of SkeletonModifier3D
  IKModifier3D* = ptr object of SkeletonModifier3D
  LimitAngularVelocityModifier3D* = ptr object of SkeletonModifier3D
  LookAtModifier3D* = ptr object of SkeletonModifier3D
  ModifierBoneTarget3D* = ptr object of SkeletonModifier3D
  PhysicalBoneSimulator3D* = ptr object of SkeletonModifier3D
  RetargetModifier3D* = ptr object of SkeletonModifier3D
  SkeletonIK3D* = ptr object of SkeletonModifier3D
  SpringBoneSimulator3D* = ptr object of SkeletonModifier3D
  XRBodyModifier3D* = ptr object of SkeletonModifier3D
  XRHandModifier3D* = ptr object of SkeletonModifier3D
  SpringBoneCollisionCapsule3D* = ptr object of SpringBoneCollision3D
  SpringBoneCollisionPlane3D* = ptr object of SpringBoneCollision3D
  SpringBoneCollisionSphere3D* = ptr object of SpringBoneCollision3D
  ...
  OpenXRVisibilityMask* = ptr object of VisualInstance3D
  ...
  EditorExportPlatformIOS* = ptr object of EditorExportPlatformAppleEmbedded
  EditorExportPlatformVisionOS* = ptr object of EditorExportPlatformAppleEmbedded
  ...
  AnimationNodeExtension* = ptr object of AnimationNode
  ...
  JointLimitationCone3D* = ptr object of JointLimitation3D
  ...
  OpenXRActionBindingModifier* = ptr object of OpenXRBindingModifier
  OpenXRIPBindingModifier* = ptr object of OpenXRBindingModifier
  OpenXRHapticVibration* = ptr object of OpenXRHapticBase
  ...
  StreamPeerTCP* = ptr object of StreamPeerSocket
  StreamPeerUDS* = ptr object of StreamPeerSocket
  TextServerAdvanced* = ptr object of TextServerExtension
  TextServerDummy* = ptr object of TextServerExtension
  OpenXRSpatialEntityTracker* = ptr object of XRPositionalTracker
  ...
  FoldableContainer* = ptr object of Container
  ...
  AimModifier3D* = ptr object of BoneConstraint3D
  ConvertTransformModifier3D* = ptr object of BoneConstraint3D
  CopyTransformModifier3D* = ptr object of BoneConstraint3D
  ChainIK3D* = ptr object of IKModifier3D
  TwoBoneIK3D* = ptr object of IKModifier3D
  ...
  OpenXRAnalogThresholdModifier* = ptr object of OpenXRActionBindingModifier
  OpenXRDpadBindingModifier* = ptr object of OpenXRIPBindingModifier
  GDScriptSyntaxHighlighter* = ptr object of EditorSyntaxHighlighter
  ...
  DPITexture* = ptr object of Texture2D
  ...
  OpenXRAnchorTracker* = ptr object of OpenXRSpatialEntityTracker
  OpenXRMarkerTracker* = ptr object of OpenXRSpatialEntityTracker
  OpenXRPlaneTracker* = ptr object of OpenXRSpatialEntityTracker
  ...
  EditorDock* = ptr object of MarginContainer
  OpenXRBindingModifierEditor* = ptr object of PanelContainer
  ...
  IterateIK3D* = ptr object of ChainIK3D
  SplineIK3D* = ptr object of ChainIK3D
  ...
  OpenXRInteractionProfileEditorBase* = ptr object of HBoxContainer
  ColorPicker* = ptr object of VBoxContainer
  ScriptEditorBase* = ptr object of VBoxContainer
  FileSystemDock* = ptr object of EditorDock
  PhysicalBone2D* = ptr object of RigidBody2D
  AnimatableBody2D* = ptr object of StaticBody2D
  CCDIK3D* = ptr object of IterateIK3D
  FABRIK3D* = ptr object of IterateIK3D
  JacobianIK3D* = ptr object of IterateIK3D
  ...
  EditorFileDialog* = ptr object of FileDialog
  ...
  OpenXRInteractionProfileEditor* = ptr object of OpenXRInteractionProfileEditorBase
...
template EngineClass*(_: typedesc[GodotInstance]): typedesc = GodotInstance
...
template EngineClass*(_: typedesc[NavigationServer2DManager]): typedesc = NavigationServer2DManager
template EngineClass*(_: typedesc[NavigationServer3D]): typedesc = NavigationServer3D
template EngineClass*(_: typedesc[NavigationServer3DManager]): typedesc = NavigationServer3DManager
template EngineClass*(_: typedesc[Node]): typedesc = Node
template EngineClass*(_: typedesc[OS]): typedesc = OS
template EngineClass*(_: typedesc[OpenXRExtensionWrapper]): typedesc = OpenXRExtensionWrapper
...
template EngineClass*(_: typedesc[ShaderIncludeDB]): typedesc = ShaderIncludeDB
...
template EngineClass*(_: typedesc[OpenXRAndroidThreadSettingsExtension]): typedesc = OpenXRAndroidThreadSettingsExtension
template EngineClass*(_: typedesc[OpenXRExtensionWrapperExtension]): typedesc = OpenXRExtensionWrapperExtension
template EngineClass*(_: typedesc[OpenXRFrameSynthesisExtension]): typedesc = OpenXRFrameSynthesisExtension
template EngineClass*(_: typedesc[OpenXRFutureExtension]): typedesc = OpenXRFutureExtension
template EngineClass*(_: typedesc[OpenXRRenderModelExtension]): typedesc = OpenXRRenderModelExtension
template EngineClass*(_: typedesc[OpenXRSpatialAnchorCapability]): typedesc = OpenXRSpatialAnchorCapability
template EngineClass*(_: typedesc[OpenXRSpatialEntityExtension]): typedesc = OpenXRSpatialEntityExtension
template EngineClass*(_: typedesc[OpenXRSpatialMarkerTrackingCapability]): typedesc = OpenXRSpatialMarkerTrackingCapability
template EngineClass*(_: typedesc[OpenXRSpatialPlaneTrackingCapability]): typedesc = OpenXRSpatialPlaneTrackingCapability
...
template EngineClass*(_: typedesc[EditorContextMenuPlugin]): typedesc = EditorContextMenuPlugin
...
template EngineClass*(_: typedesc[EditorExportPreset]): typedesc = EditorExportPreset
...
template EngineClass*(_: typedesc[GLTFObjectModelProperty]): typedesc = GLTFObjectModelProperty
...
template EngineClass*(_: typedesc[JavaObject]): typedesc = JavaObject
...
template EngineClass*(_: typedesc[Logger]): typedesc = Logger
...
template EngineClass*(_: typedesc[OpenXRFutureResult]): typedesc = OpenXRFutureResult
template EngineClass*(_: typedesc[OpenXRSpatialCapabilityConfigurationBaseHeader]): typedesc = OpenXRSpatialCapabilityConfigurationBaseHeader
template EngineClass*(_: typedesc[OpenXRSpatialComponentData]): typedesc = OpenXRSpatialComponentData
template EngineClass*(_: typedesc[OpenXRStructureBase]): typedesc = OpenXRStructureBase
...
template EngineClass*(_: typedesc[ScriptBacktrace]): typedesc = ScriptBacktrace
...
template EngineClass*(_: typedesc[SocketServer]): typedesc = SocketServer
...
template EngineClass*(_: typedesc[TranslationDomain]): typedesc = TranslationDomain
...
template EngineClass*(_: typedesc[GridMapEditorPlugin]): typedesc = GridMapEditorPlugin
...
template EngineClass*(_: typedesc[OpenXRRenderModel]): typedesc = OpenXRRenderModel
template EngineClass*(_: typedesc[OpenXRRenderModelManager]): typedesc = OpenXRRenderModelManager
...
template EngineClass*(_: typedesc[SpringBoneCollision3D]): typedesc = SpringBoneCollision3D
...
template EngineClass*(_: typedesc[EditorExportPlatformAppleEmbedded]): typedesc = EditorExportPlatformAppleEmbedded
template EngineClass*(_: typedesc[EditorExportPlatformExtension]): typedesc = EditorExportPlatformExtension
...
template EngineClass*(_: typedesc[OpenXRSpatialCapabilityConfigurationAnchor]): typedesc = OpenXRSpatialCapabilityConfigurationAnchor
template EngineClass*(_: typedesc[OpenXRSpatialCapabilityConfigurationAprilTag]): typedesc = OpenXRSpatialCapabilityConfigurationAprilTag
template EngineClass*(_: typedesc[OpenXRSpatialCapabilityConfigurationAruco]): typedesc = OpenXRSpatialCapabilityConfigurationAruco
template EngineClass*(_: typedesc[OpenXRSpatialCapabilityConfigurationMicroQrCode]): typedesc = OpenXRSpatialCapabilityConfigurationMicroQrCode
template EngineClass*(_: typedesc[OpenXRSpatialCapabilityConfigurationPlaneTracking]): typedesc = OpenXRSpatialCapabilityConfigurationPlaneTracking
template EngineClass*(_: typedesc[OpenXRSpatialCapabilityConfigurationQrCode]): typedesc = OpenXRSpatialCapabilityConfigurationQrCode
template EngineClass*(_: typedesc[OpenXRSpatialComponentAnchorList]): typedesc = OpenXRSpatialComponentAnchorList
template EngineClass*(_: typedesc[OpenXRSpatialComponentBounded2DList]): typedesc = OpenXRSpatialComponentBounded2DList
template EngineClass*(_: typedesc[OpenXRSpatialComponentBounded3DList]): typedesc = OpenXRSpatialComponentBounded3DList
template EngineClass*(_: typedesc[OpenXRSpatialComponentMarkerList]): typedesc = OpenXRSpatialComponentMarkerList
template EngineClass*(_: typedesc[OpenXRSpatialComponentMesh2DList]): typedesc = OpenXRSpatialComponentMesh2DList
template EngineClass*(_: typedesc[OpenXRSpatialComponentMesh3DList]): typedesc = OpenXRSpatialComponentMesh3DList
template EngineClass*(_: typedesc[OpenXRSpatialComponentParentList]): typedesc = OpenXRSpatialComponentParentList
template EngineClass*(_: typedesc[OpenXRSpatialComponentPersistenceList]): typedesc = OpenXRSpatialComponentPersistenceList
template EngineClass*(_: typedesc[OpenXRSpatialComponentPlaneAlignmentList]): typedesc = OpenXRSpatialComponentPlaneAlignmentList
template EngineClass*(_: typedesc[OpenXRSpatialComponentPlaneSemanticLabelList]): typedesc = OpenXRSpatialComponentPlaneSemanticLabelList
template EngineClass*(_: typedesc[OpenXRSpatialComponentPolygon2DList]): typedesc = OpenXRSpatialComponentPolygon2DList
template EngineClass*(_: typedesc[OpenXRSpatialQueryResultData]): typedesc = OpenXRSpatialQueryResultData
template EngineClass*(_: typedesc[OpenXRSpatialContextPersistenceConfig]): typedesc = OpenXRSpatialContextPersistenceConfig
...
template EngineClass*(_: typedesc[ColorPalette]): typedesc = ColorPalette
...
template EngineClass*(_: typedesc[FoldableGroup]): typedesc = FoldableGroup
...
template EngineClass*(_: typedesc[JointLimitation3D]): typedesc = JointLimitation3D
...
template EngineClass*(_: typedesc[OpenXRBindingModifier]): typedesc = OpenXRBindingModifier
template EngineClass*(_: typedesc[OpenXRHapticBase]): typedesc = OpenXRHapticBase
...
template EngineClass*(_: typedesc[ResourceImporterSVG]): typedesc = ResourceImporterSVG
...
template EngineClass*(_: typedesc[UDSServer]): typedesc = UDSServer
...
template EngineClass*(_: typedesc[StreamPeerSocket]): typedesc = StreamPeerSocket
...
template EngineClass*(_: typedesc[SubtweenTweener]): typedesc = SubtweenTweener
...
template EngineClass*(_: typedesc[BoneConstraint3D]): typedesc = BoneConstraint3D
template EngineClass*(_: typedesc[BoneTwistDisperser3D]): typedesc = BoneTwistDisperser3D
template EngineClass*(_: typedesc[IKModifier3D]): typedesc = IKModifier3D
template EngineClass*(_: typedesc[LimitAngularVelocityModifier3D]): typedesc = LimitAngularVelocityModifier3D
template EngineClass*(_: typedesc[LookAtModifier3D]): typedesc = LookAtModifier3D
template EngineClass*(_: typedesc[ModifierBoneTarget3D]): typedesc = ModifierBoneTarget3D
template EngineClass*(_: typedesc[PhysicalBoneSimulator3D]): typedesc = PhysicalBoneSimulator3D
template EngineClass*(_: typedesc[RetargetModifier3D]): typedesc = RetargetModifier3D
template EngineClass*(_: typedesc[SkeletonIK3D]): typedesc = SkeletonIK3D
template EngineClass*(_: typedesc[SpringBoneSimulator3D]): typedesc = SpringBoneSimulator3D
...
template EngineClass*(_: typedesc[SpringBoneCollisionCapsule3D]): typedesc = SpringBoneCollisionCapsule3D
template EngineClass*(_: typedesc[SpringBoneCollisionPlane3D]): typedesc = SpringBoneCollisionPlane3D
template EngineClass*(_: typedesc[SpringBoneCollisionSphere3D]): typedesc = SpringBoneCollisionSphere3D
...
template EngineClass*(_: typedesc[OpenXRVisibilityMask]): typedesc = OpenXRVisibilityMask
...
template EngineClass*(_: typedesc[EditorExportPlatformVisionOS]): typedesc = EditorExportPlatformVisionOS
...
template EngineClass*(_: typedesc[AnimationNodeExtension]): typedesc = AnimationNodeExtension
...
template EngineClass*(_: typedesc[JointLimitationCone3D]): typedesc = JointLimitationCone3D
...
template EngineClass*(_: typedesc[OpenXRActionBindingModifier]): typedesc = OpenXRActionBindingModifier
template EngineClass*(_: typedesc[OpenXRIPBindingModifier]): typedesc = OpenXRIPBindingModifier
template EngineClass*(_: typedesc[OpenXRHapticVibration]): typedesc = OpenXRHapticVibration
...
template EngineClass*(_: typedesc[StreamPeerUDS]): typedesc = StreamPeerUDS
...
template EngineClass*(_: typedesc[OpenXRSpatialEntityTracker]): typedesc = OpenXRSpatialEntityTracker
...
template EngineClass*(_: typedesc[FoldableContainer]): typedesc = FoldableContainer
...
template EngineClass*(_: typedesc[AimModifier3D]): typedesc = AimModifier3D
template EngineClass*(_: typedesc[ConvertTransformModifier3D]): typedesc = ConvertTransformModifier3D
template EngineClass*(_: typedesc[CopyTransformModifier3D]): typedesc = CopyTransformModifier3D
template EngineClass*(_: typedesc[ChainIK3D]): typedesc = ChainIK3D
template EngineClass*(_: typedesc[TwoBoneIK3D]): typedesc = TwoBoneIK3D
...
template EngineClass*(_: typedesc[OpenXRAnalogThresholdModifier]): typedesc = OpenXRAnalogThresholdModifier
template EngineClass*(_: typedesc[OpenXRDpadBindingModifier]): typedesc = OpenXRDpadBindingModifier
template EngineClass*(_: typedesc[GDScriptSyntaxHighlighter]): typedesc = GDScriptSyntaxHighlighter
...
template EngineClass*(_: typedesc[DPITexture]): typedesc = DPITexture
template EngineClass*(_: typedesc[ExternalTexture]): typedesc = ExternalTexture
...
template EngineClass*(_: typedesc[OpenXRAnchorTracker]): typedesc = OpenXRAnchorTracker
template EngineClass*(_: typedesc[OpenXRMarkerTracker]): typedesc = OpenXRMarkerTracker
template EngineClass*(_: typedesc[OpenXRPlaneTracker]): typedesc = OpenXRPlaneTracker
...
template EngineClass*(_: typedesc[EditorDock]): typedesc = EditorDock
template EngineClass*(_: typedesc[OpenXRBindingModifierEditor]): typedesc = OpenXRBindingModifierEditor
...
template EngineClass*(_: typedesc[IterateIK3D]): typedesc = IterateIK3D
template EngineClass*(_: typedesc[SplineIK3D]): typedesc = SplineIK3D
...
template EngineClass*(_: typedesc[EditorToaster]): typedesc = EditorToaster
template EngineClass*(_: typedesc[OpenXRInteractionProfileEditorBase]): typedesc = OpenXRInteractionProfileEditorBase
...
template EngineClass*(_: typedesc[CCDIK3D]): typedesc = CCDIK3D
template EngineClass*(_: typedesc[FABRIK3D]): typedesc = FABRIK3D
template EngineClass*(_: typedesc[JacobianIK3D]): typedesc = JacobianIK3D
...
template EngineClass*(_: typedesc[OpenXRInteractionProfileEditor]): typedesc = OpenXRInteractionProfileEditor
