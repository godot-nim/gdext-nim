...
# `in(Color Dictionary)`
# `in(Color Array)`
# `in(Color PackedColorArray)`
func `-`*(left: Color): Color = {.noSideEffect.}: `-(Color)`(getPtr left, nil, addr result)
func `+`*(left: Color): Color = {.noSideEffect.}: `+(Color)`(getPtr left, nil, addr result)
func `not`*(left: Color): bool = {.noSideEffect.}: `not(Color)`(getPtr left, nil, addr result)
func `*`*(left: Color; right: Int): Color = {.noSideEffect.}: `*(Color Int)`(getPtr left, getPtr right, addr result)
func `/`*(left: Color; right: Int): Color = {.noSideEffect.}: `/(Color Int)`(getPtr left, getPtr right, addr result)
func `*`*(left: Color; right: Float): Color = {.noSideEffect.}: `*(Color Float)`(getPtr left, getPtr right, addr result)
func `/`*(left: Color; right: Float): Color = {.noSideEffect.}: `/(Color Float)`(getPtr left, getPtr right, addr result)
func `+`*(left: Color; right: Color): Color = {.noSideEffect.}: `+(Color Color)`(getPtr left, getPtr right, addr result)
func `-`*(left: Color; right: Color): Color = {.noSideEffect.}: `-(Color Color)`(getPtr left, getPtr right, addr result)
func `*`*(left: Color; right: Color): Color = {.noSideEffect.}: `*(Color Color)`(getPtr left, getPtr right, addr result)
func `/`*(left: Color; right: Color): Color = {.noSideEffect.}: `/(Color Color)`(getPtr left, getPtr right, addr result)
proc load_Color_operators {.execon: staticevents.init_engine.on_load_builtinclassOperator.} =
  `-(Color)` = load(opNegate, VariantType_Color, VariantType_Nil)
  `+(Color)` = load(opPositive, VariantType_Color, VariantType_Nil)
  `not(Color)` = load(opNot, VariantType_Color, VariantType_Nil)
  `*(Color Int)` = load(opMultiply, VariantType_Color, VariantType_Int)
  `/(Color Int)` = load(opDivide, VariantType_Color, VariantType_Int)
  `*(Color Float)` = load(opMultiply, VariantType_Color, VariantType_Float)
  `/(Color Float)` = load(opDivide, VariantType_Color, VariantType_Float)
  `+(Color Color)` = load(opAdd, VariantType_Color, VariantType_Color)
  `-(Color Color)` = load(opSubtract, VariantType_Color, VariantType_Color)
  `*(Color Color)` = load(opMultiply, VariantType_Color, VariantType_Color)
  `/(Color Color)` = load(opDivide, VariantType_Color, VariantType_Color)
